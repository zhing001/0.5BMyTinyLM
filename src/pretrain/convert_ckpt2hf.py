...
def write_model(args, input_base_path, model_size, config_dir):
    ...
    for checkpoint_dir in checkpoint_dirs:
        ...
        model.save_pretrained(args.output_dir, state_dict=checkpoint_state_dict, max_shard_size="3GB", safe_serialization=False)
